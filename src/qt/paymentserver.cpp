...
const QString BITCOIN_IPC_PREFIX("beezy:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/beezy-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/beezy-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/beezy-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click beezy: links
...
//
// OSX-specific way of handling beezy: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in beezy: URIs
